...
public class ObjetivoResource {
    ...
    /**
     * Crea un nuevo objetivo con la información que se recibe en el cuerpo de
    ...
    /**
     * Busca y devuelve todas los objetivos que existen en la aplicación.
     *
    ...
    /**
     * Actualiza el objetivo con el id recibido en la URL con la información
