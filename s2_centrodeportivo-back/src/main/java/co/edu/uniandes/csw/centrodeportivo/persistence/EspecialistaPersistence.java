...
/**
 * Clase que maneja la persistencia para Especialista. Se conecta a través Entity
...
public class EspecialistaPersistence {
     ...
     *
     * @param especialistaId: id correspondiente a la especialista buscada.
     ...
     * de la especialista
     *
     * @param especialistaId: id correspondiente a la especialista a borrar.
     */
    ...
    /**
     * Busca si hay algún especialista con el nombre que se envía de argumento
     *
     * @param name: Nombre del especialista que se está buscando
     * @return null si no existe ningún especialista con el nombre del argumento.
